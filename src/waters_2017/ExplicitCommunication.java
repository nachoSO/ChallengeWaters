...
//private double WCRT_Task_3 = 0;
	...
	public ExplicitCommunication (int Task1 , double BCST1, double WCRT1, int Task2 , double BCST2, double WCRT2, int Task3 , double BCST3, double WCRT3) {
		Task_1 	= Task1;
		BCST_1	= BCST1;	
		WCRT_1 	= WCRT1;
		Task_2 	= Task2;
	...
	public double DeltaCalculation (int Task_W,  double BCST_W, double WCRT_W, int Task_R,  double BCST_R, double WCRT_R) throws IOException {
	double delta = 0;
	double phi_R = PhiCalculation(Task_W, BCST_W, WCRT_W); 
	...
	public void L2LCalculation () throws IOException {
		double L2L = BCST_1 + PhiCalculation(Task_1,  BCST_1, WCRT_1) + PhiCalculation( Task_2,  BCST_2, WCRT_2);
	...
	public void F2FCalculation () throws IOException {
		double F2F = PhiCalculation(Task_1,  BCST_1, WCRT_1) + PhiCalculation (Task_2,  BCST_2, WCRT_2) + PhiCalculation ( Task_3,  BCST_3, WCRT_3);
